    ...
    public partial class AcsDemo : Form
    {
        ...
        protected void mouseClickDeviceTreeNode(object send, TreeNodeMouseClickEventArgs e)
        {
            ...
            if ((e.Node.Level) == 0 || (e.Node.Level == 1))
            {
                ...
                tabPageCapture.Parent = tabControlAcs;
        ...
        private void buttonCardManagement_Click(object sender, EventArgs e)
        {
            ...
            struCardManagement.m_iEncodeType = g_deviceTree.g_struDeviceInfo[index].byCharaterEncodeType;
            ...
            for (int i = 0; i < readerCardNum; i++)
            {
                ...
                switch (m_struAcsWorkStatus.byCardReaderVerifyMode[i])
                {
                    ...
                    case 20:
                        ...
                        break;
                    case 21:
                        items[2] = "EmployeeNo&Face";
                        break;
                    case 22:
                        items[2] = "Face or Face&Card";
                        break;
                    case 23:
                        items[2] = "FP or Face";
                        break;
                    case 24:
                        items[2] = "Card or Face or Password";
                        break;
                    case 25:
                        items[2] = "Card or Face";
                        break;
                    case 26:
                        items[2] = "Card or Face or FP";
                        break;
                    case 27:
                        items[2] = "Card or FP or Password";
                        break;
                    case 28:
                        items[2] = "Face or Password";
                        break;
                    case 29:
                        items[2] = "EmpployeeNo&Face&Password";
                        break;
                    case 30:
                        items[2] = "Card or Face or Face&Card";
                        break;
                    default:
                        items[2] = m_struAcsWorkStatus.byCardReaderVerifyMode[i].ToString();
                        break;
                }
        ...
        private void buttonDoorHolidayGroupManagement_Click(object sender, EventArgs e)
        {
            ...
            doorHolidayGroupPlan.m_iEncodeType = g_deviceTree.g_struDeviceInfo[index].byCharaterEncodeType;
        ...
        private void buttonDoorPlanTemplateManagement_Click(object sender, EventArgs e)
        {
            ...
            doorTemplate.m_iEncodeType = g_deviceTree.g_struDeviceInfo[index].byCharaterEncodeType;
        ...
        private void buttonDoorCfgSave_Click(object sender, EventArgs e)
        {
            ...
            if (g_deviceTree.g_struDeviceInfo[iDeviceIndex].byCharaterEncodeType == 6)
            {
                byTemp = System.Text.Encoding.UTF8.GetBytes(textBoxDoorName.Text);
            }
            else 
            {
                byTemp = System.Text.Encoding.Default.GetBytes(textBoxDoorName.Text);
            }
        ...
        private void ShowDoorConfiguration()
        {
            ...
            {
                textBoxDoorName.Text = System.Text.Encoding.Default.GetString(struDoorCfg.byDoorName);
            }
        ...
        private void buttonCardReaderHolidayGroupManagement_Click(object sender, EventArgs e)
        {
            ...
            cardReaderHolidayGroupPlan.m_iEncodeType = g_deviceTree.g_struDeviceInfo[index].byCharaterEncodeType;
        ...
        private void buttonCardReaderPlanTemplateManagement_Click(object sender, EventArgs e)
        {
            ...
            cardReaderTemplate.m_iEncodeType = g_deviceTree.g_struDeviceInfo[index].byCharaterEncodeType;
        ...
        private void buttonCardHolidayGroupManagement_Click(object sender, EventArgs e)
        {
            ...
            cardHolidayGroupPlan.m_iEncodeType = g_deviceTree.g_struDeviceInfo[index].byCharaterEncodeType;
        ...
        private void buttonCardPlanTemplateManagement_Click(object sender, EventArgs e)
        {
            ...
            cardTemplate.m_iEncodeType = g_deviceTree.g_struDeviceInfo[index].byCharaterEncodeType;
        ...
        private void ShowCardReaderConfiguration()
        {
            ...
            if((struReaderCfg.wCardReaderFunction & 0x01) == 0x01)
                comboBoxCardeReaderType.SelectedIndex = 0;
            if ((struReaderCfg.wCardReaderFunction & 0x02) == 0x02)
                comboBoxCardeReaderType.SelectedIndex = 1;
            if ((struReaderCfg.wCardReaderFunction & 0x04) == 0x04)
                comboBoxCardeReaderType.SelectedIndex = 2;
        ...
        private void btnFPManagementbyStaffCenter_Click(object sender, EventArgs e)
        {
            int index = g_deviceTree.GetCurDeviceIndex();
            if (index < 0) return;
            FingerPrintMgrByStaffCenter dlg = new FingerPrintMgrByStaffCenter();
            dlg.m_lUserID = g_deviceTree.g_struDeviceInfo[index].lLoginID;
            dlg.ShowDialog();
            dlg.Dispose();
        }
        ...
        private void buttonDataSearch_Click(object sender, EventArgs e)
        {
            int index = g_deviceTree.GetCurDeviceIndex();
            if (index < 0) return;
            CaptureDataSearch dataSearch = new CaptureDataSearch();
            dataSearch.m_lUserID = g_deviceTree.g_struDeviceInfo[index].lLoginID;
