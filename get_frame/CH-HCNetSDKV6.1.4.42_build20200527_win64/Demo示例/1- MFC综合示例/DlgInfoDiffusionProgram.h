...
public:
    ...
    afx_msg void OnBnClickedBtnProgramThumbnailSave();
    afx_msg void OnBnClickedBtnProgramThumbnailDownload();
    afx_msg void OnBnClickedBtnProgramThumbnailSelete();
    afx_msg void OnBnClickedBtnProgramThumbnailUpload();
    CString m_csThumbnailSavePath;
    CString m_csThumbnailSeletePath;
    DWORD m_dwProgramThumbnailID;
    DWORD m_dwProgramThumbnaillSize;
    DWORD m_dwTemplatteThumbnaillSize;
    LONG m_lUpdownloadHandle; //上传/下载句柄
    afx_msg void OnBnClickedBtnTemplateThumbnailSave2();
    afx_msg void OnBnClickedBtnTemplateThumbnailSelete2();
    afx_msg void OnBnClickedBtnTemplateThumbnailDownload2();
    afx_msg void OnBnClickedBtnTemplateThumbnailUpload2();
    CProgressCtrl m_ctrlProgress;
    CStatic m_statProgress;
    CString m_csTemplateSeletePath;
    CString m_csTemplateSavePath;
    DWORD m_dwTemplateThumbnailID;
