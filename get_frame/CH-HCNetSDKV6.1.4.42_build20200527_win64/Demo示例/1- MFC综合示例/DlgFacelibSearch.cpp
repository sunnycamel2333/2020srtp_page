        ...
        if (xmlBase.FindElem("MatchList") && xmlBase.IntoElem())
        {
            do
            {
                if (xmlBase.FindElem("MatchElement") && xmlBase.IntoElem())
                {
                    ...
                    {
                        string str_gb2312 = UTF2GB(xmlBase.GetData().c_str());
                        m_listSearchResult.SetItemText(iRowCount, iIndex, str_gb2312.c_str());
                    }
                    else
                    {
                        m_listSearchResult.SetItemText(iRowCount, iIndex, "unknown");
                    ...
                    else if (xmlBase.FindElem("ModelingStatus") && xmlBase.IntoElem())
                    {
