...
BOOL CDlgRtspConfig::OnInitDialog()
{
    ...
    g_pMainDlg->AddLog(m_iDeviceIndex, OPERATION_SUCC_T, "NET_DVR_GetRtspConfig,RTSP:%d, RTSPS:%d", m_struRtspCfg.wPort, m_struRtspCfg.wRtspsPort);
    m_iPort = m_struRtspCfg.wPort;
    m_iRTSPSPort = m_struRtspCfg.wRtspsPort;
...
void CDlgRtspConfig::OnBtnSet() 
{
    ...
    m_struRtspCfg.wRtspsPort = m_iRTSPSPort;
