...
void CDlgUpnpCfg::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Text(pDX, IDC_EDIT_RTSPS_PORT, m_iRtspsPort);
    ...
    DDX_Check(pDX, IDC_CHK_ENABLE_RTSPS, m_bEnableRtsps);
...
void CDlgUpnpCfg::OnButtonUpdate() 
{
	...
	{
        g_pMainDlg->AddLog(m_dwDeviceIndex, OPERATION_SUCC_T, "NET_DVR_GET_NAT_CFG, RTSP映射：%d, RTSPS映射：%d", m_strNatCfg.struRtspPort.wExtPort, m_strNatCfg.struRtspsPort.wExtPort);
        ...
        m_bEnableRtsps = m_strNatCfg.struRtspsPort.wEnable;
        m_iRtspsPort = m_strNatCfg.struRtspsPort.wExtPort;
...
void CDlgUpnpCfg::OnButtonSetup() 
{
    ...
    m_strNatCfg.struRtspsPort.wEnable = m_bEnableRtsps;
    m_strNatCfg.struRtspsPort.wExtPort = m_iRtspsPort;
	...
	{
		g_pMainDlg->AddLog(m_dwDeviceIndex, OPERATION_SUCC_T, "NET_DVR_SET_NAT_CFG");
	}
}
