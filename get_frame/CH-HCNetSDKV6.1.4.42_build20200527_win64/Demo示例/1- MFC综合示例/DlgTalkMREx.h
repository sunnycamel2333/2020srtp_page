...
public:
    ...
    void ExitPlayAudio(BYTE *lpeTmp, BYTE *lpPlayBuf, void *pDecoder, void *pG726Dec, void *pG726DecM, void *pG711Dec, BYTE byIndex);
...
protected:
    ...
    void*   m_pG711Enc; //g77±àÂë¾ä±ú£¬Ä¿Ç°win64ÓÃ
