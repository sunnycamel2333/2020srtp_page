...
void CDlgLcdUserCfg::OnBtnSet() 
{
    ...
    memcpy(m_struUserCfg.sPassWord, m_csPassword, sizeof(m_struUserCfg.sPassWord));
    memcpy(m_struUserCfg.sLoginPassword, m_csPasswordSure, sizeof(m_struUserCfg.sLoginPassword));
