...
// 	NET_DVR_COMPRESSIONCFG_EX m_struCompressionCfg[MAX_CHANNUM_V30];
	...
	void CheckRebootParam(DWORD *dwCurVal, int iModVal, BOOL bJudge);
    ...
    CComboBox m_combUpDownBoundary;
    CComboBox m_combLeftRightBoundary;
    BOOL m_bLowBitRate;
    BOOL m_bAngle;
    int m_iTiltAngleX;
    int m_iTiltAngleY;
    afx_msg void OnBnClickedChkAngle();
};
