...
void CDlgACCardParam::UpdateInterface(BOOL bRefresh)
{
    ...
    string str_utf8 = GB2UTF((const char *)(struCardInfo.byName));
    memset(struCardInfo.byName, 0, sizeof(struCardInfo.byName));
    strncpy((char *)struCardInfo.byName, str_utf8.c_str(), str_utf8.length());
