...
CDlgDevServer::CDlgDevServer(CWnd* pParent /*=NULL*/)
    ...
    , m_bEanbledCaptureWithSupplimentLight(FALSE)
{
...
void CDlgDevServer::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Check(pDX, IDC_CHECK49, m_bEanbledCaptureWithSupplimentLight);
}
...
//	m_struDevServerCfg.byEnablePrivateMulticastDiscovery = m_comMultDisco.GetCurSel();
    ...
    m_struDevServerCfg.byCaptureWithSupplimentLightEnabled = m_bEanbledCaptureWithSupplimentLight;
...
//	m_comMultDisco.SetCurSel(m_struDevServerCfg.byEnablePrivateMulticastDiscovery);
    ...
    m_bEanbledCaptureWithSupplimentLight = m_struDevServerCfg.byCaptureWithSupplimentLightEnabled;
