    ...
    case NET_SDK_CALLBACK_TYPE_STATUS:
		{
            ...
            {
                g_pMainDlg->AddLog(pThis->m_iDevIndex, OPERATION_FAIL_T, "Capture Finger Print CallBack failed [%d]", *((DWORD*)pRecvDataBuffer + 1));
            }
            ...
            {
                g_pMainDlg->AddLog(pThis->m_iDevIndex, OPERATION_FAIL_T, "Capture Finger Print CallBack failed");
            }
