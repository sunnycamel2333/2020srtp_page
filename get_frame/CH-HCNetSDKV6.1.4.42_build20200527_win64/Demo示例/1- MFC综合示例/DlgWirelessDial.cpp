...
void CDlgWirelessDial::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Check(pDX, IDC_CHK_ENABLE_4G, m_bEnable4G);
    DDX_Check(pDX, IDC_CHK_ENABLE_DNS, m_bEnableDNS);
}
...
//     m_strPassword = m_struWirelessDialCfg.byPassword;
       ...
       m_bEnable4G = m_struWirelessDialCfg.byEnabled4G;
       m_bEnableDNS = m_struWirelessDialCfg.byEnabledDNS;
    }
    UpdateData(FALSE);
}
...
void CDlgWirelessDial::OnBtnWirelessDialSave() 
{
    ...
    m_struWirelessDialCfg.byEnabled4G = m_bEnable4G;
    m_struWirelessDialCfg.byEnabledDNS = m_bEnableDNS;
...
void CDlgWirelessDial::OnBtnAlarmInTimeOk() 
{
    ...
    if (7 == i)
    {
        m_struWirelessDialSchedule.struHolidayAlarmTime[0].byStartHour = (BYTE)m_iHour11;
        m_struWirelessDialSchedule.struHolidayAlarmTime[0].byStartMin = (BYTE)m_iMin11;
        m_struWirelessDialSchedule.struHolidayAlarmTime[0].byStopHour = (BYTE)m_iHour12;
        m_struWirelessDialSchedule.struHolidayAlarmTime[0].byStopMin = (BYTE)m_iMin12;
        m_struWirelessDialSchedule.struHolidayAlarmTime[1].byStartHour = (BYTE)m_iHour21;
        m_struWirelessDialSchedule.struHolidayAlarmTime[1].byStartMin = (BYTE)m_iMin21;
        m_struWirelessDialSchedule.struHolidayAlarmTime[1].byStopHour = (BYTE)m_iHour22;
        m_struWirelessDialSchedule.struHolidayAlarmTime[1].byStopMin = (BYTE)m_iMin22;
        m_struWirelessDialSchedule.struHolidayAlarmTime[2].byStartHour = (BYTE)m_iHour31;
        m_struWirelessDialSchedule.struHolidayAlarmTime[2].byStartMin = (BYTE)m_iMin31;
        m_struWirelessDialSchedule.struHolidayAlarmTime[2].byStopHour = (BYTE)m_iHour32;
        m_struWirelessDialSchedule.struHolidayAlarmTime[2].byStopMin = (BYTE)m_iMin32;
        m_struWirelessDialSchedule.struHolidayAlarmTime[3].byStartHour = (BYTE)m_iHour41;
        m_struWirelessDialSchedule.struHolidayAlarmTime[3].byStartMin = (BYTE)m_iMin41;
        m_struWirelessDialSchedule.struHolidayAlarmTime[3].byStopHour = (BYTE)m_iHour42;
        m_struWirelessDialSchedule.struHolidayAlarmTime[3].byStopMin = (BYTE)m_iMin42;
        m_struWirelessDialSchedule.struHolidayAlarmTime[4].byStartHour = (BYTE)m_iHour51;
        m_struWirelessDialSchedule.struHolidayAlarmTime[4].byStartMin = (BYTE)m_iMin51;
        m_struWirelessDialSchedule.struHolidayAlarmTime[4].byStopHour = (BYTE)m_iHour52;
        m_struWirelessDialSchedule.struHolidayAlarmTime[4].byStopMin = (BYTE)m_iMin52;
        m_struWirelessDialSchedule.struHolidayAlarmTime[5].byStartHour = (BYTE)m_iHour61;
        m_struWirelessDialSchedule.struHolidayAlarmTime[5].byStartMin = (BYTE)m_iMin61;
        m_struWirelessDialSchedule.struHolidayAlarmTime[5].byStopHour = (BYTE)m_iHour62;
        m_struWirelessDialSchedule.struHolidayAlarmTime[5].byStopMin = (BYTE)m_iMin62;
        m_struWirelessDialSchedule.struHolidayAlarmTime[6].byStartHour = (BYTE)m_iHour71;
        m_struWirelessDialSchedule.struHolidayAlarmTime[6].byStartMin = (BYTE)m_iMin71;
        m_struWirelessDialSchedule.struHolidayAlarmTime[6].byStopHour = (BYTE)m_iHour72;
        m_struWirelessDialSchedule.struHolidayAlarmTime[6].byStopMin = (BYTE)m_iMin72;
        m_struWirelessDialSchedule.struHolidayAlarmTime[7].byStartHour = (BYTE)m_iHour81;
        m_struWirelessDialSchedule.struHolidayAlarmTime[7].byStartMin = (BYTE)m_iMin81;
        m_struWirelessDialSchedule.struHolidayAlarmTime[7].byStopHour = (BYTE)m_iHour82;
        m_struWirelessDialSchedule.struHolidayAlarmTime[7].byStopMin = (BYTE)m_iMin82;
    }
    else
    {
...
void CDlgWirelessDial::OnBtnAlarminTimeCopy() 
{
    ...
    else if (7 == m_nCopyTime)
    {
        for (k = 0; k < MAX_TIMESEGMENT_V30; k++)
        {
            memcpy(&m_struWirelessDialSchedule.struHolidayAlarmTime[k], &m_struWirelessDialSchedule.struAlarmTime[i][k], sizeof(NET_DVR_SCHEDTIME));
        }
    }
    else
    {
...
void CDlgWirelessDial::OnSelchangeComboAlarminWeekday() 
{
    ...
    if (7 == i)
    {
        m_iHour11 = m_struWirelessDialSchedule.struHolidayAlarmTime[0].byStartHour;
        m_iMin11 = m_struWirelessDialSchedule.struHolidayAlarmTime[0].byStartMin;
        m_iHour12 = m_struWirelessDialSchedule.struHolidayAlarmTime[0].byStopHour;
        m_iMin12 = m_struWirelessDialSchedule.struHolidayAlarmTime[0].byStopMin;
        m_iHour21 = m_struWirelessDialSchedule.struHolidayAlarmTime[1].byStartHour;
        m_iMin21 = m_struWirelessDialSchedule.struHolidayAlarmTime[1].byStartMin;
        m_iHour22 = m_struWirelessDialSchedule.struHolidayAlarmTime[1].byStopHour;
        m_iMin22 = m_struWirelessDialSchedule.struHolidayAlarmTime[1].byStopMin;
        m_iHour31 = m_struWirelessDialSchedule.struHolidayAlarmTime[2].byStartHour;
        m_iMin31 = m_struWirelessDialSchedule.struHolidayAlarmTime[2].byStartMin;
        m_iHour32 = m_struWirelessDialSchedule.struHolidayAlarmTime[2].byStopHour;
        m_iMin32 = m_struWirelessDialSchedule.struHolidayAlarmTime[2].byStopMin;
        m_iHour41 = m_struWirelessDialSchedule.struHolidayAlarmTime[3].byStartHour;
        m_iMin41 = m_struWirelessDialSchedule.struHolidayAlarmTime[3].byStartMin;
        m_iHour42 = m_struWirelessDialSchedule.struHolidayAlarmTime[3].byStopHour;
        m_iMin42 = m_struWirelessDialSchedule.struHolidayAlarmTime[3].byStopMin;
        m_iHour51 = m_struWirelessDialSchedule.struHolidayAlarmTime[4].byStartHour;
        m_iMin51 = m_struWirelessDialSchedule.struHolidayAlarmTime[4].byStartMin;
        m_iHour52 = m_struWirelessDialSchedule.struHolidayAlarmTime[4].byStopHour;
        m_iMin52 = m_struWirelessDialSchedule.struHolidayAlarmTime[4].byStopMin;
        m_iHour61 = m_struWirelessDialSchedule.struHolidayAlarmTime[5].byStartHour;
        m_iMin61 = m_struWirelessDialSchedule.struHolidayAlarmTime[5].byStartMin;
        m_iHour62 = m_struWirelessDialSchedule.struHolidayAlarmTime[5].byStopHour;
        m_iMin62 = m_struWirelessDialSchedule.struHolidayAlarmTime[5].byStopMin;
        m_iHour71 = m_struWirelessDialSchedule.struHolidayAlarmTime[6].byStartHour;
        m_iMin71 = m_struWirelessDialSchedule.struHolidayAlarmTime[6].byStartMin;
        m_iHour72 = m_struWirelessDialSchedule.struHolidayAlarmTime[6].byStopHour;
        m_iMin72 = m_struWirelessDialSchedule.struHolidayAlarmTime[6].byStopMin;
        m_iHour81 = m_struWirelessDialSchedule.struHolidayAlarmTime[7].byStartHour;
        m_iMin81 = m_struWirelessDialSchedule.struHolidayAlarmTime[7].byStartMin;
        m_iHour82 = m_struWirelessDialSchedule.struHolidayAlarmTime[7].byStopHour;
        m_iMin82 = m_struWirelessDialSchedule.struHolidayAlarmTime[7].byStopMin;
    }
