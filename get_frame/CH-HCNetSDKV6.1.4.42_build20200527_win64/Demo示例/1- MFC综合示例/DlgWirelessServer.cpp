...
void DlgWirelessServer::DoDataExchange(CDataExchange* pDX)
{
    ...
    //}}AFX_DATA_MAP
    DDX_Control(pDX, IDC_CTRL_HOT_SPOT_ENABLE2, m_comWifiApModeType);
}
...
void DlgWirelessServer::OnSet()
{
    ...
    struWirelessServer.byWifiApModeType = m_comWifiApModeType.GetCurSel();
...
void DlgWirelessServer::OnGet() 
{
    ...
    m_comWifiApModeType.SetCurSel(struWirelessServer.byWifiApModeType);
