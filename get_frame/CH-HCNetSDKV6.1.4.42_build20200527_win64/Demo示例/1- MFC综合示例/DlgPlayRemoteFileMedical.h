...
class CDlgPlayRemoteFileMedical : public CDialog
{
    DECLARE_DYNAMIC(CDlgPlayRemoteFileMedical)

public:
    CDlgPlayRemoteFileMedical(CWnd* pParent = NULL);   // standard constructor
    virtual ~CDlgPlayRemoteFileMedical();

// Dialog Data
	
public:
	//{{AFX_DATA(CDlgPlayRemoteFile)
    enum { IDD = IDD_DLG_RECORD_FILE_MEDICAL };
...
public:
    ...
    NET_DVR_FILECOND_MEDICAL m_strFileCondMedical;
    ...
    static UINT GetMedicalFileThread(LPVOID pParam);
protected: 
