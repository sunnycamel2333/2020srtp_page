...
void CDlgWallCfg_Uniform::DoDataExchange(CDataExchange* pDX)
{
    ...
    //}}AFX_DATA_MAP
    DDX_Control(pDX, IDC_COMB_OUTPUT_LINK_STATUS, m_cmbLinkStatus);
}
...
void CDlgWallCfg_Uniform::OnBtnGetCfg() 
{
	...
	else
	{
        ...
        m_cmbLinkStatus.SetCurSel(struTemp.byLinkStatus);
		UpdateData(FALSE);
...
void CDlgWallCfg_Uniform::OnSelchangeComboOutput() 
{
    ...
    m_cmbLinkStatus.SetCurSel(m_struOutput[iSel].byLinkStatus);
