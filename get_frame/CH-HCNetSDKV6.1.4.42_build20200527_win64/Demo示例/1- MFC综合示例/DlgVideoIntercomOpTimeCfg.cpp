...
void CDlgVideoIntercomOpTimeCfg::DoDataExchange(CDataExchange* pDX)
{
    ...
    //}}AFX_DATA_MAP
    DDX_Text(pDX, IDC_EDIT_RING_TIME_DURATION, m_dwRingDurationTime);
}
...
void CDlgVideoIntercomOpTimeCfg::CheckRaidoBtn()
{
    ...
    GetDlgItem(IDC_EDIT_RING_TIME_DURATION)->EnableWindow(m_nUnitType == ENUM_INDOOR_UNIT);
}
...
{   
	...
	else if (m_nUnitType == ENUM_INDOOR_UNIT)
	{
        ...
        m_dwRingDurationTime = pOpTimeCfg->uVideoIntercomUnit.struIndoorUnit.dwRingDurationTime;
	}
...
void CDlgVideoIntercomOpTimeCfg::GetParamFromWnd(NET_DVR_VIDEO_INTERCOM_OPERATION_TIME_CFG* pOpTimeCfg)
{
	...
	else if (m_nUnitType == ENUM_INDOOR_UNIT)
	{
        ...
        pOpTimeCfg->uVideoIntercomUnit.struIndoorUnit.dwRingDurationTime = m_dwRingDurationTime;
	}
