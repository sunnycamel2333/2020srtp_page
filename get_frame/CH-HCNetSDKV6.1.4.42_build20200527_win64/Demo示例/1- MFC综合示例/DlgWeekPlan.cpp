...
void CDlgWeekPlan::OnButAchgGet() 
{
    ...
    case 0:
        ...
        if (g_struDeviceInfo[m_lDeviceID].byCharaterEncodeType == 6)
        {
            BYTE tempGroupName[HOLIDAY_GROUP_NAME_LEN + 1] = { 0 };
            memcpy(tempGroupName, m_struGroupCfg.byGroupName, sizeof(m_struGroupCfg.byGroupName));
            string str_gb2312 = UTF2GB((const char *)tempGroupName);
            memset(m_struGroupCfg.byGroupName, 0, sizeof(m_struGroupCfg.byGroupName));
            strncpy((char *)m_struGroupCfg.byGroupName, str_gb2312.c_str(), str_gb2312.length());
        }
...
void CDlgWeekPlan::OnButAchgSet() 
{
    ...
    case 0:
        ...
        if (g_struDeviceInfo[m_lDeviceID].byCharaterEncodeType == 6)
        {
            string str_utf8 = GB2UTF((const char *)m_struGroupCfg.byGroupName);
            memset(m_struGroupCfg.byGroupName, 0, sizeof(m_struGroupCfg.byGroupName));
            strncpy((char *)m_struGroupCfg.byGroupName, str_utf8.c_str(), HOLIDAY_GROUP_NAME_LEN);
        }
...
void CDlgWeekPlan::OnButAcptGet() 
{
    ...
    case 0:
        ...
        if (g_struDeviceInfo[m_lDeviceID].byCharaterEncodeType == 6)
        {
            BYTE tempTemplateName[TEMPLATE_NAME_LEN + 1] = { 0 };
            memcpy(tempTemplateName, m_struTemplateCfg.byTemplateName, sizeof(m_struTemplateCfg.byTemplateName));
            string str_gb2312 = UTF2GB((const char *)tempTemplateName);
            memset(m_struTemplateCfg.byTemplateName, 0, sizeof(m_struTemplateCfg.byTemplateName));
            strncpy((char *)m_struTemplateCfg.byTemplateName, str_gb2312.c_str(), str_gb2312.length());
        }
...
void CDlgWeekPlan::OnButAcptSet()
{
    ...
    case 0:
        ...
        if (g_struDeviceInfo[m_lDeviceID].byCharaterEncodeType == 6)
        {
            string str_utf8 = GB2UTF((const char *)m_struTemplateCfg.byTemplateName);
            memset(m_struTemplateCfg.byTemplateName, 0, sizeof(m_struTemplateCfg.byTemplateName));
            strncpy((char *)m_struTemplateCfg.byTemplateName, str_utf8.c_str(), TEMPLATE_NAME_LEN);
        }
