...
BOOL CDlgSensorCfg::SetSensorCfg()
{
    ...
    m_struSensorInfo.dwSize = sizeof(m_struSensorInfo);
...
void CDlgSensorCfg::InitWnd()
{
    ...
    g_StringLanType(szLan, "AC端子", "SENSOR_TYPE_AC_TERMINAL");
    m_comboSensorType.InsertString(nIndex, szLan);
    m_comboSensorType.SetItemData(nIndex, SENSOR_TYPE_AC_TERMINAL);
    nIndex++;

    g_StringLanType(szLan, "AC插座", "SENSOR_TYPE_AC_SOCKET");
    m_comboSensorType.InsertString(nIndex, szLan);
    m_comboSensorType.SetItemData(nIndex, SENSOR_TYPE_AC_SOCKET);
    nIndex++;

    g_StringLanType(szLan, "温湿度", "SENSOR_TYPE_HUMITURE");
    m_comboSensorType.InsertString(nIndex, szLan);
    m_comboSensorType.SetItemData(nIndex, SENSOR_TYPE_HUMITURE);
    nIndex++;

    g_StringLanType(szLan, "流量", "SENSOR_TYPE_FLOW");
    m_comboSensorType.InsertString(nIndex, szLan);
    m_comboSensorType.SetItemData(nIndex, SENSOR_TYPE_FLOW);
    nIndex++;

    g_StringLanType(szLan, "液位", "SENSOR_LIQUID_LEVEL");
    m_comboSensorType.InsertString(nIndex, szLan);
    m_comboSensorType.SetItemData(nIndex, SENSOR_LIQUID_LEVEL);
    nIndex++;

    g_StringLanType(szLan, "电弧", "SENSOR_TYPE_ARC");
    m_comboSensorType.InsertString(nIndex, szLan);
    m_comboSensorType.SetItemData(nIndex, SENSOR_TYPE_ARC);
    nIndex++;
