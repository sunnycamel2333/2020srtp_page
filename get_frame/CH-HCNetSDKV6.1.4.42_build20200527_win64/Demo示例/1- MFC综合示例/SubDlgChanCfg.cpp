...
void CSubDlgChanCfg::AddResolution()
{
    ...
    m_comboResolution.InsertString(index, "4800*1600");
    m_comboResolution.SetItemData(index, 353);
    index++;

    m_comboResolution.InsertString(index, "3600*1200");
    ...
    m_comboResolution.InsertString(index, "2400*800");
    m_comboResolution.SetItemData(index, 356);
    index++;

    m_comboResolution.InsertString(index, "1200*400");
