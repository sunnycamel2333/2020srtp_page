...
CDlgVideoIntercomRoomCustomCfg::~CDlgVideoIntercomRoomCustomCfg()
{
    ...
    PULONG_PTR lpArr = GetRoomCustomCfgPoint();
...
PULONG_PTR CDlgVideoIntercomRoomCustomCfg::GetRoomCustomCfgPoint()
{
    if (!m_lpRoomCustomCfg)
    {
        const int iMaxRoomCustomNum = 6000;
        m_lpRoomCustomCfg = new ULONG_PTR[iMaxRoomCustomNum];
        memset(m_lpRoomCustomCfg, 0, sizeof(ULONG_PTR)*iMaxRoomCustomNum);
    }
