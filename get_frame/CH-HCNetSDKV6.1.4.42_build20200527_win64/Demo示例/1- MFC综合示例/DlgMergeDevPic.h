...
protected:
    ...
    afx_msg void OnBnClickedBtnSetupLonglink();
    afx_msg void OnBnClickedBtnSendPicByBuf();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
public:
    ...
    LONG m_lUploadByBufLongHandle;
    HANDLE	m_hPicUpLoadThread;
    HANDLE	m_hPicUpLoadLongThread;
    bool m_bIsSending;
    ...
    static DWORD WINAPI PicUpLoadByBufLongThread(LPVOID pParam);
    afx_msg void OnDestroy();
    CComboBox m_cmUploadSendPicType;
    BOOL m_byPicOverlayEnabled;
    CComboBox m_comboFlash;
    CComboBox m_comboShow;
    CComboBox m_comboTranslucent;
    CComboBox m_comboPicType;
    DWORD m_dwOutputNo;
    DWORD m_dwWindowNo;
    afx_msg void OnBnClickedBtnClsoseLonglink();
};
